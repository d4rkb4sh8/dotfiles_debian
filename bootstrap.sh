...
APT_PACKAGES=(
  ...
  openrc pkg-config postgresql-contrib procps python-is-python3 rc rkhunter snapd stow tldr terminator tmux ufw uptimed thefuck vlc whois w3m wget wikipedia2text zathura
)
